<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageNotree.master" AutoEventWireup="true" CodeFile="Outbound.aspx.cs" Inherits="Outbound" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        ...
        //外撥
        function MobileSend() {
            var msg = "MAKECALL0" + document.getElementById("ContentPlaceHolder1_txbPhone").value + ",,255723078";

<%@ Page Language="C#" MasterPageFile="~/MasterPageNotree.master" AutoEventWireup="true" CodeFile="DefaultWait.aspx.cs" Inherits="DefaultWait" Title="台灣優勢外撥紀錄" %>
        ...
        <tr>
            <td class="style2" style="text-align: left">
                ...
                　<asp:Button ID="btnCallOut" runat="server" BackColor="#FFDDCC" Height="36px" 
                    OnClientClick="OpenURL('外撥視窗','http://172.30.22.50/OBON/Outbound.aspx?agentid=$_AGENT_ID_$')" 
                    Text="外撥" Width="120px" />
                                </td>
        </tr>
        <tr>
